...
import { index, store } from '@/routes/admin/games';
import type { BreadcrumbItem } from '@/types';
import type { Category } from '@/types/data/category';
import type { GameElement, GameType } from '@/types/data/game';
...
const { categories, defaultType } = defineProps<Props>();

const typeNames = {
    emparejar: 'Emparejar',
    secuencia: 'Secuencias Lógicas',
    emocion: 'Reconocimiento de Emociones',
};
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: `Nuevo Juego de ${typeNames[defaultType]}`,
        href: '#',
    },
];
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-muted-foreground">
                        Configura un nuevo juego o actividad dinámica para los
                        pacientes.
                    </p>
                </div>
            </div>
